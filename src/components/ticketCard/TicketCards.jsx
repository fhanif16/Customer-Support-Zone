  ...
  return (
    <div className='grid grid-cols-12 gap-4'>
        ...
        <div className="col-span-12 lg:col-span-9">
            <h1 className='text-2xl ml-6 mt-6 font-bold'>Customer Tickets</h1>
        ...
        <div className="col-span-12 lg:col-span-3">
            <div>
                <h1 className='text-2xl ml-6 mt-6 font-bold'>Task Status</h1>
            <TaskStatus task={task} handleResolved={handleResolved}></TaskStatus>
            </div>
            
           <div>
            <h1 className='text-2xl ml-6 mt-6 font-bold'>Resolved Task</h1>
